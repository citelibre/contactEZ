...
-- INSERT INTO `matomo_log_action` VALUES (1,'CiteLibre ContactEZ - Home',2755426357,4,NULL),(2,'localhost:8080/contactEZ/jsp/site/Portal.jsp',4280245483,1,0),(3,'localhost:8080/contactEZ/',730637562,1,0),(4,'CiteLibre ContactEZ - Demande d&#039;acte de Mariage - Pour votre demande d&#039;acte, veuillez préciser le motif',3132300288,4,NULL),(5,'localhost:8080/contactEZ/jsp/site/Portal.jsp?page=forms&view=stepView&id_form=4&init=true',2523549751,1,0),(6,'CiteLibre ContactEZ - Demande d&#039;acte de Mariage - Votre demande',4082456046,4,NULL),(7,'localhost:8080/contactEZ/jsp/site/Portal.jsp?page=forms',521397587,1,0),(8,'CiteLibre ContactEZ - Contacter ma mairie - Ma demande',2942564248,4,NULL),(9,'localhost:8080/contactEZ/jsp/site/Portal.jsp?page=forms&view=stepView&id_form=1&init=true',3879599221,1,0);
...
INSERT INTO `matomo_site` VALUES (1,'Cité Libre ContactEZ','http://localhost:8080/contactEZ','2022-10-24 12:53:29',0,1,'','','Europe/Paris','USD',0,'','','','','','website',0,'anonymous');
